...
public class ArticleServiceIntegrationTest {
    ...
    public void testFindAllPremiereCategorie() {
        ...
        // then: la réponse est un article de la catégorie "Sport"
        Assertions.assertEquals("Sport", (articleService.findAllArticles().get(0).getCategorie()));
    }
    ...
    public void testArticleRecupereeInchangee() {
        ...
        Assertions.assertEquals(fetched.getTitre(), a.getTitre());
        Assertions.assertEquals(fetched.getCategorie(), a.getCategorie());
    }
